...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl mobile-text-base md:text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "mobile-button [&_svg]:mobile-icon-sm",
        sm: "mobile-button-sm [&_svg]:mobile-icon-xs",
        lg: "mobile-button-lg [&_svg]:mobile-icon-base",
        icon: "mobile-touch-target [&_svg]:mobile-icon-base",
      },
    },
    defaultVariants: {
      variant: "default",
